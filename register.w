...
<span component="$UI/system/components/justep/timer/timer" xid="timer" style="top:11px;left:866px;" onTimer="dtimerTimer" enabled="false"></span><resource xid="resource2"><require xid="require2" url="css!$UI/mine/aiwojia/css/font-awesome/css/fa.icons"></require></resource>
  </div>
