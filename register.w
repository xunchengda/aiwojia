...
<div xmlns="http://www.w3.org/1999/xhtml" class="login-main" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:533px;left:30px;"> 
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="regdata" idColumn="id" autoNew="true"> 
      <column label="id" name="id" type="Integer" xid="xid1"/>  
      <column label="用户名" name="name" type="String" xid="xid2"/>  
      <column label="手机号" name="mobile" type="String" xid="xid3"/>  
      <column label="身份证号" name="idno" type="String" xid="xid4"/>  
      <column label="验证码" name="code" type="String" xid="xid5"/>  
      <data xid="default1">[{"id":1}]</data>  
      <column label="密码" name="password" type="String" xid="xid6"/>  
      <rule xid="rule1"> 
        ...
        <col name="mobile" xid="ruleCol3"> 
          ...
          <constraint xid="constraint3"> 
            ...
            <expr xid="default11">$model.checkMobile($row.val('mobile'))</expr> 
          </constraint> 
        </col>  
        <col name="idno" xid="ruleCol4"> 
          ...
          <constraint xid="constraint4"> 
            ...
            <expr xid="default12">$model.checkID($row.val('idno'))</expr> 
          </constraint> 
        </col>  
      ...
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        ...
        <div class="x-titlebar-left" xid="left1"> 
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon"
            ...
            <i xid="i5" class="fa fa-angle-left fa-fw"/>  
            <span xid="span6"/> 
          </a> 
        </div>  
...
=======
        <div class="list-group-item"> 
          <div component="$UI/system/components/justep/row/row" class="x-row"
            xid="row1"> 
            <div class="form-item-icon" xid="col1"> 
            ...
            <div xid="col2" class="x-col"> 
              <input component="$UI/system/components/justep/input/input" class="form-control x-inputText"
                xid="nameInput" placeHolder="用户名" bind-ref="$model.regdata.ref(&quot;name&quot;)"/> 
            </div> 
          </div> 
        </div>  
        <div class="list-group-item" xid=""> 
          <div component="$UI/system/components/justep/row/row" class="x-row"
            xid="row2"> 
            <div class="form-item-icon" xid="col4"> 
            ...
            <div class="x-col" xid="col5"> 
              <input component="$UI/system/components/justep/input/input" class="form-control x-inputText"
                xid="mobileInput" placeHolder="手机号" bind-ref="$model.regdata.ref(&quot;mobile&quot;)"/> 
            </div> 
          </div> 
        </div>  
        <div class="list-group-item" xid=""> 
          <div component="$UI/system/components/justep/row/row" class="x-row"
            ...
            <div class="x-col" xid="col8"> 
              <input component="$UI/system/components/justep/input/input" class="form-control x-inputText"
                xid="idInput" placeHolder="身份证号" bind-ref="$model.regdata.ref(&quot;idno&quot;)"/> 
            </div> 
          </div> 
        </div>  
        <div class="list-group-item" xid="div6"> 
          <div component="$UI/system/components/justep/row/row" class="x-row"
            ...
            <div class="x-col" xid="col11"> 
              <input component="$UI/system/components/justep/input/password"
                ...
                bind-ref="$model.regdata.ref(&quot;password&quot;)"/> 
            </div> 
          </div> 
        </div>  
        <div class="list-group-item" xid=""> 
          ...
          <div component="$UI/system/components/justep/row/row" class="x-row"
            xid="row5"> 
            <div class="form-item-icon" xid="col13"> 
              <span class="input-group-addon" xid=""> 
                <i class="fa fa-commenting fa-lg fa-fw" xid=""/> 
              </span> 
            </div>  
            <div class="x-col" xid="col14"> 
              <input component="$UI/system/components/justep/input/input" class="form-control x-inputText"
                xid="codeInput" placeHolder="验证码" style="width:101%;" bind-ref="$model.regdata.ref(&quot;code&quot;)"/> 
            </div>  
            <div class="x-col x-col-30" xid="col16"> 
              <a component="$UI/system/components/justep/button/button" class="btn x-green btn-default pull-left"
                label="获取验证码" xid="getSmsBtn" style="line-height:0px;padding: 16px;width:120px;margin-left:10px;float:right;"> 
                <i xid="i1"/>  
                <span xid="span1">获取验证码</span> 
              </a> 
            </div> 
          </div> 
        </div> 
      ...
      <a component="$UI/system/components/justep/button/button" class="btn x-black btn-lg btn-only-label btn-block text-info list-group"
        label="注    册" xid="registerBtn" style="background-color:#ee9c13;color:#4C4C4C;border-width:0px 0px 0px 0px;"
        onClick="btnRegClick"> 
        <i xid="i4"/>  
        <span xid="span4">注 册</span> 
      </a>  
      <a component="$UI/system/components/justep/button/button" class="btn btn-link"
        label="我有帐号，直接登录" xid="gotoLoginBtn" style="float:right;color:#666666;" onClick="btnLoginClick"> 
        <i xid="i6"/>  
        <span xid="span7">我有帐号，直接登录</span> 
      </a> 
    </div>  
