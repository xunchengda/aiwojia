...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:470px;left:89px;" onParamsReceive="modelParamsReceive"> 
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="addressData" idColumn="address_id">
   ...
   <column label="state" name="state" type="String" xid="xid15"></column></div>
    ...
    <div class="x-panel-content x-cards" xid="content1"> 
      <div component="$UI/system/components/justep/panel/panel" class="panel panel-default x-card tb-noborder media"
        ...
        <div class="media-body"> 
          <h4 class="text-black" bind-text="$model.currentAddressData.ref('true_name')" xid="name"><![CDATA[]]></h4>  
