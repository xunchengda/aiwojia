...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <column label="筛选选中状态" name="state" type="Integer" xid="xid17"></column></div></div>  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full x-card x-has-iosstatusbar"> 
    <div class="x-panel-top" height="88"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar tb-index" title="休闲服务"> 
        ...
        <div class="x-titlebar-title" xid="div20" bind-click="searchBtnClick">休闲服务</div>  
